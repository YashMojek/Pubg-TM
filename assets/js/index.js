...
function app() {
	...
	const app = {
		...
		info(){
			...
			const ContactList = [
				{degre:'Programmist', value:'Pälwan Nurgeldiýew', img:'assets/images/developer.svg',},
				{degre:'Gmail', value:'Nurgeldiyewhacker@gmail.com', img:'assets/images/email.svg'},
				{degre:'Telegram', value:'@upxnn', img:'assets/images/telegram.svg'},
				{degre:'Start', value:'@upxnn', img:'assets/images/start.svg', order:'bottom'}
			...
			AppInfoList = [
				{param:'App ady', setParam:'Pubg TM'},
				{param:'Versiýasy', setParam:'0.0.1'},
				{param:'Start', setParam:'@kaifarik_gaming'}
			]
